...
$(document).ready(function () {
    ...
    //position: fixed
    $("body").append("<div id='divShowInfoTag'>"
        + "<b>Css Selector:</b></br><textarea id='cssSelector'></textarea>"
        + "<br/><div class='totaltooltip'>"
        + "<button style = 'padding:3px 5px; background:green;  border:solid 1px #CCC; cursor: pointer; margin: 3px;' onclick = 'myFunction()' onmouseout = 'outFunc()'>Copy</button></div> "
        + "<button style = 'padding:3px 5px; background:green;  border:solid 1px #CCC; cursor: pointer; margin: 3px;' onclick = 'getFullCss();' > Full Css</button>"
        + "<button style = 'padding:3px 5px; background:green;  border:solid 1px #CCC; cursor: pointer; margin: 3px;' onclick = 'AddCss();' > Append</button>"
        + "<button style = 'padding:3px 5px; background:green;  border:solid 1px #CCC; cursor: pointer; margin: 3px;' onclick = 'TestCss();' > Test</button>"
        + "<button style = 'padding:3px 5px; background:green;  border:solid 1px #CCC; cursor: pointer; margin: 3px;' onclick = 'ReplaceCss();' > Replace</button>"
        + "<button style = 'padding:3px 5px; background:green;  border:solid 1px #CCC; cursor: pointer; margin: 3px;' onclick = 'ExcludeCss();' > Exclude</button>"
        + "<div style='float: right'><input id='myClose' type='button' value='Đóng' style='padding:3px 5px; background:#9d234c;  border:solid 1px #CCC; cursor: pointer; margin: 3px'/></div></div>");
